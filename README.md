...
`use-locale` focuses on small identifier primitives grounded in BCP 47 language tags, Unicode CLDR/LDML locale concepts, ISO country and currency code shapes, and IANA time zone identifier shapes.
